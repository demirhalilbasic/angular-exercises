...
For detailed documentation in Bosnian/Croatian/Serbian language, see [DOKUMENTACIJA.md](./DOKUMENTACIJA.md).

---

## 📖 Documentation

- **[DOKUMENTACIJA.md](./DOKUMENTACIJA.md)** - Comprehensive step-by-step guide in Bosnian/Croatian/Serbian
- **[Angular Documentation](https://angular.dev)** - Official Angular documentation
